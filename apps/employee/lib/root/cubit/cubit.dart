...
get navigatorKeys => state.navigatorKeys;
  void handleBackPressed() {
    ...
    if (navigator != null && navigator.canPop()) {
      ...
      emit(state.copyWith(rootStatus: RootStatus.reseatHomeIndex,ccurrentIndex: 0));
    }
  ...
  bool shouldShowAction() {
    return state.ccurrentIndex == 0 || state.ccurrentIndex == 2 || state.ccurrentIndex == 5;
  }

  void selectedIndex(int index){
    emit(state.copyWith(rootStatus: RootStatus.selectNavBarIndex,ccurrentIndex: index));
  }
}
...
class AppTypography {
  ...
  static TextStyle titleSmall([Color? color]) => _applyColor(
    const TextStyle(fontSize: 18, fontWeight: FontWeight.w600, height: 1.3),
    color,
  );
  ...
  static TextStyle bodyMedium([Color? color]) => _applyColor(
    const TextStyle(fontSize: 14, fontWeight: FontWeight.normal, height: 1.4),
    color,
  );
  ...
  static TextStyle caption([Color? color]) => _applyColor(
    const TextStyle(fontSize: 11, fontWeight: FontWeight.w300, height: 1.3),
    color,
  );
